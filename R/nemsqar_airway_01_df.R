#' Synthetic Test Data for Airway-18 Measure in National EMS Information System
#'
#' This dataset provides completely synthetic test data for evaluating the `airway_01`
#' and `airway_01_population` functions in the `nemsqar` package. It contains fields relevant
...
#' }
#'
#' @usage data(nemsqar_airway_01_df)
#'
#' @examples
#' data(nemsqar_airway_01_df)
#' head(nemsqar_airway_01_df)
#'
"nemsqar_airway_01_df"
