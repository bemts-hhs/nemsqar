...
#'   where the respiratory rate, SBP, and GCS vitals were taken. `denominator`:
#'   Total count of incidents. `prop`: Proportion of incidents where the
#'   respiratory rate, SBP, and GCS vitals were taken. `prop_label`: Proportion
#'   formatted as a percentage with a specified number of decimal places.
#'
