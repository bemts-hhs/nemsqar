...
#'   where patient weight was documented. `denominator`: Total count of
#'   incidents. `prop`: Proportion of incidents where patient weight was
#'   documented. `prop_label`: Proportion formatted as a percentage with a
