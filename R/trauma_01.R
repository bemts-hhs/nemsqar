...
#'   where a pain scale was administered. `denominator`: Total count of
#'   incidents. `prop`: Proportion of incidents where a pain scale was
#'   administered. `prop_label`: Proportion formatted as a percentage with a
