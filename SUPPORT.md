...
Thanks for using nemsqar! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/bemts-hhs/nemsqar/issues/new).
...
requests](https://github.com/bemts-hhs/nemsqar/issues) to make sure the
...
Please don’t worry if you do not get an immediate response, we will try
and get back to you as soon as possible. When issues are submitted via
GitHub (not email!) and they include a reprex, it will help me address
your concern quickly. Remember, if we cannot reproduce your problem, we
cannot help you fix it. So use reprex!
